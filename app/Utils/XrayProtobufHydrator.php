...
class XrayProtobufHydrator
{
    ...
    public static function hydrateOutbound(array $config): \Xray\Core\OutboundHandlerConfig
    {
        ...
        // Basic placeholder for outbound proxy settings (e.g. VLESS)
        // Full hydration of VLESS outbound requires wrapping in TypedMessage
        // which is complex. For now, we return the basic object with the tag.
    ...
    protected static function verifyFilesystemPaths(array $config): void
    {
        array_walk_recursive($config, function ($value, $key) {
            ...
            if (in_array($key, ['certificateFile', 'keyFile'])) {
