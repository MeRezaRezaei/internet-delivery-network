 ...
 *
 * Protobuf type <code>xray.common.geodata.Domain.Type</code>
 */
class Type
{
    /**
     ...
     *
     * Generated from protobuf enum <code>Substr = 0;</code>
     */
    const Substr = 0;
    /**
...
class_alias(Type::class, \Xray\Common\Geodata\Domain_Type::class);
