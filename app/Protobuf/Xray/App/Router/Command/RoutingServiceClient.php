...
class RoutingServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Xray\App\Router\Command\ListRuleRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function ListRule(\Xray\App\Router\Command\ListRuleRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/xray.app.router.command.RoutingService/ListRule',
        $argument,
        ['\Xray\App\Router\Command\ListRuleResponse', 'decode'],
        $metadata, $options);
    }
