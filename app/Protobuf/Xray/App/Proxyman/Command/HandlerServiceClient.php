...
class HandlerServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Xray\App\Proxyman\Command\ListInboundsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function ListInbounds(\Xray\App\Proxyman\Command\ListInboundsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/xray.app.proxyman.command.HandlerService/ListInbounds',
        $argument,
        ['\Xray\App\Proxyman\Command\ListInboundsResponse', 'decode'],
        $metadata, $options);
    }

    /**
     * @param \Xray\App\Proxyman\Command\GetInboundUserRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GetInboundUsers(\Xray\App\Proxyman\Command\GetInboundUserRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/xray.app.proxyman.command.HandlerService/GetInboundUsers',
        $argument,
        ['\Xray\App\Proxyman\Command\GetInboundUserResponse', 'decode'],
        $metadata, $options);
    }
     ...
     * @return \Grpc\UnaryCall
     */
    public function GetInboundUsersCount(\Xray\App\Proxyman\Command\GetInboundUserRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/xray.app.proxyman.command.HandlerService/GetInboundUsersCount',
        $argument,
        ['\Xray\App\Proxyman\Command\GetInboundUsersCountResponse', 'decode'],
        $metadata, $options);
    }
    ...
    /**
     * @param \Xray\App\Proxyman\Command\ListOutboundsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function ListOutbounds(\Xray\App\Proxyman\Command\ListOutboundsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/xray.app.proxyman.command.HandlerService/ListOutbounds',
        $argument,
        ['\Xray\App\Proxyman\Command\ListOutboundsResponse', 'decode'],
        $metadata, $options);
    }
