...
{
    /**
     * Generated from protobuf field <code>.xray.transport.internet.DomainStrategy domain_strategy = 1;</code>
     */
    ...
    private $noises;
    /**
     * Generated from protobuf field <code>repeated .xray.proxy.freedom.FinalRuleConfig final_rules = 8;</code>
     */
    private $final_rules;
     ...
     *     @type array<\Xray\Proxy\Freedom\FinalRuleConfig>|\Google\Protobuf\Internal\RepeatedField $final_rules
     * }
     */
     ...
     * @return \Google\Protobuf\Internal\RepeatedField
     */
    public function getFinalRules()
    {
        return $this->final_rules;
    }

    /**
     * Generated from protobuf field <code>repeated .xray.proxy.freedom.FinalRuleConfig final_rules = 8;</code>
     * @param array<\Xray\Proxy\Freedom\FinalRuleConfig>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFinalRules($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Xray\Proxy\Freedom\FinalRuleConfig::class);
        $this->final_rules = $arr;
