...
class DeviceConfig extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>bool no_kernel_tun = 9;</code>
     */
    protected $no_kernel_tun = false;
     ...
     * @return bool
     */
    public function getNoKernelTun()
    {
        return $this->no_kernel_tun;
    }
     ...
     * @return $this
     */
    public function setNoKernelTun($var)
    {
        GPBUtil::checkBool($var);
        $this->no_kernel_tun = $var;
