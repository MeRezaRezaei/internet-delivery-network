...
## High Priority
- [x] **IDN-060 Subscription Service Implementation**: Created the `feat/sub-service` branch with a dedicated Marzban DB connection, Eloquent models, and a custom subscription controller for XHTTP/SplitHTTP templates. [COMPLETED] (2026-06-05)
